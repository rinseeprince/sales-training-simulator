-- Template Scenarios Database Schema
...
-- Add template tracking to existing scenarios table
ALTER TABLE scenarios 
ADD COLUMN IF NOT EXISTS template_id UUID REFERENCES template_scenarios(id),
